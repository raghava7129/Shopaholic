...
public class stats extends AppCompatActivity {
    ...
    TextView perct5,perct4,perct3,perct2,perct1;
        ...
        updateProref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                if(total_reviews == 0){
                    ...
                    p5.setProgress(100 * (numStars[4] / total_reviews));
                    p4.setProgress(100 * (numStars[3] / total_reviews));
                    p3.setProgress(100 * (numStars[2] / total_reviews));
                    p2.setProgress(100 * (numStars[1] / total_reviews));
                    p1.setProgress(100 * (numStars[0] / total_reviews));

                    String s5 = 100 * (numStars[4] / total_reviews) + "%";
                    String s4 = 100 * (numStars[3] / total_reviews) + "%";
                    String s3 = 100 * (numStars[2] / total_reviews) + "%";
                    String s2 = 100 * (numStars[1] / total_reviews) + "%";
                    String s1 = 100 * (numStars[0] / total_reviews) + "%";
